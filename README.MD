...
![alt text](https://img.shields.io/github/issues/Tanishq112005/Test_app)


![alt text](https://img.shields.io/github/forks/Tanishq112005/Test_app)


![alt text](https://img.shields.io/github/stars/Tanishq112005/Test_app)
...
![alt text](link_to_your_login_screenshot.png)
	
![alt text](link_to_your_setup_screenshot.png)
	
![alt text](link_to_your_arena_screenshot.png)
✨ Key Features
...
Web Scraping: Puppeteer (for gathering problem data)
...
TypeScript and ts-node installed globally. If not, run:
...
MONGO_DB: Your connection string from MongoDB Atlas.

JWT_SECRET: A long, random, and secret string for signing authentication tokens.

GOOGLE_API_KEY: Get this from the Google Cloud Console.
...
Navigate to the frontend/src/keys/ directory.

Open the file that contains the backend URL variable (e.g., links.ts).

Find the BACKEND_URL variable and replace its value with your local backend address, using the port you set in the .env file.
...
Navigate into the backend/src directory:
...
First, compile your TypeScript code. From the main backend directory, run:
...
Tanishq - @Tanishq112005

Project Link: https://github.com/Tanishq112005/Test_app